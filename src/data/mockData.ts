...
export const mockProducts: Product[] = [
  ...
  createProduct({
    id: '9',
    title: 'Aura Smart Glasses',
    slug: 'aura-smart-glasses',
    description: 'Óculos inteligentes com realidade aumentada integrada e design clássico.',
    price: 399.99,
    salePrice: 299.99,
    brand: 'Aura',
    category: 'wearables',
  ...
  createProduct({
    id: '10',
    title: 'Nexus Wireless Charger',
    slug: 'nexus-wireless-charger',
    description: 'Carregador sem fio de alta velocidade com base de alumínio anodizado.',
    price: 89.99,
    salePrice: null,
    brand: 'Nexus',
  ...
  createProduct({
    id: '11',
    title: 'Zenith Noise Cancelling Earbuds',
    slug: 'zenith-earbuds',
    description: 'Fones de ouvido in-ear com cancelamento ativo de ruído e áudio espacial.',
    price: 199.99,
    salePrice: null,
    brand: 'Zenith',
    category: 'audio',
  ...
  createProduct({
    ...
    description: 'Luminária de mesa inteligente com controle de temperatura de cor.',
    price: 129.99,
    salePrice: 99.99,
    brand: 'Lumina',
    category: 'home',
  ...
  createProduct({
    ...
    description: 'Teclado mecânico wireless com switches customizados e retroiluminação RGB sutil.',
    price: 159.99,
    salePrice: null,
    brand: 'Apex',
    category: 'accessories',
